    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="px-6 py-4 border-b flex items-start justify-between"
          ...
          <div>
            <h2 className="text-lg font-bold" style={{color: '#ec4899'}}>
              {title}
            </h2>
            {message && (
          ...
          >
            <svg className="w-5 h-5" style={{color: '#d1d5db'}} fill="currentColor" viewBox="0 0 20 20">
          ...
          <button
            ...
            style={{
              background: isDangerous
                ...
                : 'linear-gradient(135deg, #f5a9c8 0%, #ec4899 100%)'
            }}
          >
            {confirmText}
          </button>
